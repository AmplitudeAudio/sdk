...
function(am_buildsystem_get_runnable_archs ARCH_LIST_VAR)
    foreach (ARCH ${AM_BUILDSYSTEM_ARCHS_PRI})
        ...
        SET(CAN_RUN_${ARCH}_EXITCODE OFF CACHE BOOL "Result from TRY_RUN" FORCE)
        SET(CAN_RUN_${ARCH}_EXITCODE__TRYRUN_OUTPUT OFF CACHE BOOL "Result from TRY_RUN" FORCE)
