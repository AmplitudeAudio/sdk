...
{
    AM_TEST_CASE(EngineTestCase, core_engine, channel_can_be_paused_with_delay)
    {
    public:
        void Run() override
        {
    ...
    AM_REGISTER_TEST(core_engine, channel_can_be_paused_with_delay);
} // namespace SparkyStudios::Audio::Amplitude::Tests
