...
{
    AM_TEST_CASE(EngineTestCase, core_channel_instances, stale_instance_handle_is_invalid_after_removal)
    {
    public:
        void Run() override
        {
    ...
    AM_REGISTER_TEST(core_channel_instances, stale_instance_handle_is_invalid_after_removal);
} // namespace SparkyStudios::Audio::Amplitude::Tests
