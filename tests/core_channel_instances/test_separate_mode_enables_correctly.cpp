...
{
    AM_TEST_CASE(EngineTestCase, core_channel_instances, separate_mode_enables_correctly)
    {
    public:
        void Run() override
        {
    ...
    AM_REGISTER_TEST(core_channel_instances, separate_mode_enables_correctly);
} // namespace SparkyStudios::Audio::Amplitude::Tests
