...
{
    AM_TEST_CASE(PureUnitTestCase, math_barycentric_coordinates, can_be_computed_from_a_ray_triangle_intersection)
    {
    public:
        void Run() override
        {
            ...
            AM_EXPECT(BarycentricCoordinates::RayTriangleIntersection(rayOrigin, rayDirection, triangle, coordinates));
    ...
    AM_REGISTER_TEST(math_barycentric_coordinates, can_be_computed_from_a_ray_triangle_intersection);
} // namespace SparkyStudios::Audio::Amplitude::Tests
