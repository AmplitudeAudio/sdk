...
{
    AM_TEST_CASE(ComponentTestCase, dsp_filters, biquad_resonant_filter_parameters)
    {
    public:
        void Run() override
        {
            ...
            AM_EXPECT_EQ(
                instance->GetParameter(BiquadResonantFilter::ATTRIBUTE_TYPE), static_cast<AmReal32>(BiquadResonantFilter::TYPE_HIGH_PASS));
            ...
            AM_EXPECT_EQ(
                filter->GetParameterMax(BiquadResonantFilter::ATTRIBUTE_TYPE), static_cast<AmReal32>(BiquadResonantFilter::TYPE_LAST - 1));
    ...
    AM_REGISTER_TEST(dsp_filters, biquad_resonant_filter_parameters);
} // namespace SparkyStudios::Audio::Amplitude::Tests
