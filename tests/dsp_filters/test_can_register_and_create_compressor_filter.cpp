...
{
    AM_TEST_CASE(ComponentTestCase, dsp_filters, can_register_and_create_compressor_filter)
    {
    public:
        void Run() override
        {
            ...
            AM_EXPECT(Filter::Find("CompressorFilter") == nullptr);
        }
    };

    AM_REGISTER_TEST(dsp_filters, can_register_and_create_compressor_filter);
} // namespace SparkyStudios::Audio::Amplitude::Tests
