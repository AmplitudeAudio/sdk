...
{
    AM_TEST_CASE(LightEngineTestCase, mixer_nodes, ambisonic_rotator_node_skips_non_hrtf)
    {
    public:
        void SetUp() override
        {
        ...
        void Run() override
        {
            ...
            // Test 1: Position spatialization should skip
            ...
            // Test 2: HRTF without valid listener should also skip
            mockLayer.SetSpatialization(eSpatialization_HRTF);
            AM_EXPECT(processor->ShouldSkip());
        }
    };

    AM_REGISTER_TEST(mixer_nodes, ambisonic_rotator_node_skips_non_hrtf);
} // namespace SparkyStudios::Audio::Amplitude::Tests
