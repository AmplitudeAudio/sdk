...
#include <SparkyStudios/Audio/Amplitude/DSP/Reverbs/RoomReverb.h>
...
namespace SparkyStudios::Audio::Amplitude
{
    ...
    RoomReverbInstance::~RoomReverbInstance() = default;

    void RoomReverbInstance::Initialize(AmUInt32 sampleRate)
    {
        _sampleRate = sampleRate;
        _reverb = std::make_unique<Internal::RoomReverb>(sampleRate);
    }
    ...
    void RoomReverbInstance::SetRoomParameters(AmReal32 roomSize, AmReal32 absorption)
    {
        if (_reverb != nullptr)
        {
            ...
            _reverb->SetRoomAbsorption(absorption);
        }
    }
    ...
    std::shared_ptr<ReverbInstance> RoomReverb::CreateInstance()
    {
        return ampoolshared(eMemoryPoolKind_Filtering, RoomReverbInstance, this);
    }
} // namespace SparkyStudios::Audio::Amplitude
