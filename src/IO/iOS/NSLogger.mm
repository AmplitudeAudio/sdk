...
namespace SparkyStudios::Audio::Amplitude
{
    ...
    NSLogger::NSLogger(const char* logTag)
        : m_log(nullptr)
        , m_logTag([[NSString stringWithUTF8String:logTag] retain])
    {
    ...
    void NSLogger::Log(eLogMessageLevel level, const char* file, int line, const AmString& message)
    {
        if (file == nullptr)
            file = "<unknown>";
