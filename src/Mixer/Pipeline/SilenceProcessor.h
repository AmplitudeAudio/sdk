...
#ifndef _AM_IMPLEMENTATION_MIXER_PIPELINE_SILENCE_PROCESSOR_H
#define _AM_IMPLEMENTATION_MIXER_PIPELINE_SILENCE_PROCESSOR_H

#include <SparkyStudios/Audio/Amplitude/Amplitude.h>

namespace SparkyStudios::Audio::Amplitude
{
    class SilenceProcessorInstance : public SoundProcessorInstance
    {
    public:
    ...
    public:
        SilenceProcessor()
            : SoundProcessor("SilenceProcessor")
        {}

        SoundProcessorInstance* CreateInstance() override
        {
            return ampoolnew(MemoryPoolKind::Amplimix, SilenceProcessorInstance);
        }
...
#endif // _AM_IMPLEMENTATION_MIXER_PIPELINE_SILENCE_PROCESSOR_H
