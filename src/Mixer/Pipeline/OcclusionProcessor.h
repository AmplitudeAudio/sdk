...
#ifndef _AM_IMPLEMENTATION_MIXER_PIPELINE_OCCLUSION_PROCESSOR_H
#define _AM_IMPLEMENTATION_MIXER_PIPELINE_OCCLUSION_PROCESSOR_H
...
namespace SparkyStudios::Audio::Amplitude
{
    ...
    public:
        ...
        void Process(const AmplimixLayer* layer, const AudioBuffer& in, AudioBuffer& out) override
        {
            ...
            AmVec3 direction =
                GetRelativeDirection(listener.GetLocation(), listener.GetOrientation().GetQuaternion(), layer->GetLocation());
            ...
            if (const AmReal32 lpf = lpfCurve.Get(coefficient); lpf > 0)
            {
                ...
                _occlusionFilters[soundId]->Process(in, out, frames, sampleRate);
            }
...
#endif // _AM_IMPLEMENTATION_MIXER_PIPELINE_OCCLUSION_PROCESSOR_H
