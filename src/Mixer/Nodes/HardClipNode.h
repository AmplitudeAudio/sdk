...
#ifndef _AM_IMPLEMENTATION_MIXER_NODES_HARD_CLIP_NODE_H
#define _AM_IMPLEMENTATION_MIXER_NODES_HARD_CLIP_NODE_H
...
{
    class HardClipNodeInstance final : public ProcessorNodeInstance
    {
    public:
    ...
    public:
        ...
        {
            return AmSharedPtr<HardClipNodeInstance, eMemoryPoolKind_Amplimix>::Make();
        }
...
#endif // _AM_IMPLEMENTATION_MIXER_NODES_HARD_CLIP_NODE_H
