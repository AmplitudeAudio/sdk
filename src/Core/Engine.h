...
namespace SparkyStudios::Audio::Amplitude
{
    ...
    public:
        ...
        void EnsureSoundBankLoaded(const AmOsString& filename) override;
        ...
        void CancelEvents(const Entity& entity) const override;
        void CancelAllEvents() const override;
        ...
        [[nodiscard]] const AmString& GetResampler() const override;
