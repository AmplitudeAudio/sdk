...
#ifndef SS_AMPLITUDE_AUDIO_EASE_OUT_FADER_H
#define SS_AMPLITUDE_AUDIO_EASE_OUT_FADER_H
...
{
    constexpr BeizerCurveControlPoints gEaseOutFaderCurveControlPoints = { 0.0f, 0.0f, 0.58f, 1.0f };
